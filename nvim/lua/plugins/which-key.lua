require("which-key").register({
  ["<leader>"] = {
    f = {
      name = "files",
      f = { function() require('telescope.builtin')
        .find_files(require('telescope.themes').get_ivy()) end, "Find files" },
      b = { function() require('telescope.builtin')
        .buffers(require('telescope.themes').get_ivy()) end, "Search open buffers" },
    },
    g = {
      name = "+grep",
      g = { function() require('telescope.builtin')
        .live_grep(require('telescope.themes').get_ivy()) end, "Live grep" },
    },
    t = {
      name = "+nvim-tree",
