...
keys = [
	...
	Key([mod,  "shift"], "n", lazy.group.prev_window(), desc="Move window focus to previous window"),
...
monadwide_layout_theme = {
    "ratio": MONADWIDE_RATIO,
    "max_ratio": MONADWIDE_RATIO,
    "border_focus": "#88C0D0",
    "border_normal": "#3b4252",
    "border_width": DEFAULT_BORDER_WIDTH,
    "margin": DEFAULT_MARGIN,
    "single_margin": DEFAULT_MARGIN_ON_SINGLE,
